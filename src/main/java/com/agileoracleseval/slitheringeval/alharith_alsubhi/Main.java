package com.agileoracleseval.slitheringeval.alharith_alsubhi;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String filePath = "src/main/java/com/agileoracleseval/slitheringeval/alharith_alsubhi/board.txt";
        String statePath = "src/main/java/com/agileoracleseval/slitheringeval/alharith_alsubhi/snakeState.txt";
